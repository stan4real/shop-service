  ...
  return (
    <div
      ...
      className={twMerge("fixed bottom-0  left-0 z-10 h-screen w-screen overflow-hidden bg-black/50 transition-transform",
        onClose ? "animate-[fadeOut_0.4s_ease-out] opacity-0": "animate-[fadeIn_0.4s_ease-out]"
      )}
    >
      <div
        ...
        className={twMerge(
          ...
          onClose ? "animate-[slideOut_0.4s_ease-out] translate-y-1/2" : "animate-[slideIn_0.4s_ease-out] translate-y-0" ,
          className ? `${className}`:""
        )}
      >
        <div className="">
